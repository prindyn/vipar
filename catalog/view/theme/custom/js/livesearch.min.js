function doLiveSearch(e, n) {
    return 38 == e.keyCode || 40 == e.keyCode ? !1 : ($("#livesearch_search_results").remove(),
        updown = -1,
        "" == n || n.length < 3 ? !1 : (n = encodeURI(n),
            $.ajax({
...
function upDownEvent(e) {
    ...
    if (n) {
        ...
        if (-1 != updown && "undefined" != typeof n.childNodes[updown] && $(n.childNodes[updown]).removeClass("highlighted"),
            38 == e.keyCode ? updown = updown > 0 ? --updown : updown : 40 == e.keyCode && (updown = d > updown ? ++updown : updown),
            updown >= 0 && d >= updown) {
            $(n.childNodes[updown]).addClass("highlighted");
            var o = n.childNodes[updown].childNodes[0].text;
            "undefined" == typeof o && (o = n.childNodes[updown].childNodes[0].innerText),
